---
title: "Staff Regulations for MRP"
---

<div id="no-header-here" />
<div className="flex justify-center items-center w-full -mt-8">
  <h2 className="text-3xl font-bold">Regulations for Moscow RolePlay Project Staff</h2>
</div>
...
<Danger>
**Everything below is a draft and is not official information.**
</Danger>

<p align="center"><strong>D. Prohibitions</strong></p>

1. It is prohibited to show superiority over players, threaten them, or use profanity.
2. Confidentiality: It is not allowed to disclose internal project information (from Discord or private messages).
3. Reporting: The Curator, like any administrator, is required to store evidence of violations (recordings/screenshots) for 48 hours.<br />
